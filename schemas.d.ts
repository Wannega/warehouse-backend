...
export interface ApiContragentContragent extends CollectionTypeSchema {
  info: {
...
export interface ApiDictionaryDictionary extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    name: StringAttribute & RequiredAttribute & DefaultTo<'Sample name'>;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    publishedAt: DateTimeAttribute;
    createdBy: RelationAttribute<
...
export interface ApiInvoiceInvoice extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    article: StringAttribute;
    amount: IntegerAttribute;
    provider: RelationAttribute<
      'api::invoice.invoice',
      'oneToOne',
      'api::provider.provider'
    >;
    contragent: RelationAttribute<
      'api::invoice.invoice',
      'oneToOne',
      'api::contragent.contragent'
    >;
    deliveryDate: DateTimeAttribute;
...
export interface ApiProviderProvider extends CollectionTypeSchema {
  info: {
